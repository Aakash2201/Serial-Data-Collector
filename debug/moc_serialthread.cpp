...
QT_MOC_LITERAL(1, 13, 17), // "Signal_SendInData"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 15), // "setupSerialPort"
QT_MOC_LITERAL(4, 48, 8), // "mySerial"
QT_MOC_LITERAL(5, 57, 15), // "closeSerialPort"
QT_MOC_LITERAL(6, 73, 15) // "readData_Serial"

    },
    "SerialThread\0Signal_SendInData\0\0"
    "setupSerialPort\0mySerial\0closeSerialPort\0"
    "readData_Serial"
};
...
void SerialThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Signal_SendInData((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 1: _t->setupSerialPort((*reinterpret_cast< mySerial(*)>(_a[1]))); break;
        case 2: _t->closeSerialPort(); break;
        case 3: _t->readData_Serial(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SerialThread::*)(QString , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialThread::Signal_SendInData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialThread::Signal_SendInData(QString _t1, bool _t2)
{
